...
let ShellTaskRepository = class ShellTaskRepository extends TypeDataBeansRepository {
    constructor() {
        super(__dirname);
    }
};
ShellTaskRepository = __decorate([
    typeorm_1.EntityRepository(ShellTask_1.ShellTask),
    __metadata("design:paramtypes", [])
], ShellTaskRepository);
exports.ShellTaskRepository = ShellTaskRepository;
